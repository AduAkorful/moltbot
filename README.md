...
- [ ] **Phase 4.6 — Run local setup checklist** (~50 min, blocks all code work)
- [ ] Phase 5 — Build (Jul 27 → Aug 13, see `plans/next-steps.md` weeks 1-6)
- [ ] Phase 6 — Post-submit
...
31 issues are defined in [`plans/next-steps.md`](plans/next-steps.md). The first 5 (P0) are unblocked and ready to start as soon as the setup checklist is done:

1. Run local setup checklist (`plans/setup-verified.md`)
...
See `next-steps.md` for the full breakdown, dependency chains, and week-by-week schedule.
